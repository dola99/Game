...
class _$_DataModel implements _DataModel {
  ...
  @override
  String toString() {
    return 'DataModel(id: $id, title: $title, worth: $worth, thumbnail: $thumbnail, image: $image, description: $description, instructions: $instructions, openGiveawayUrl: $openGiveawayUrl, publishedDate: $publishedDate, type: $type, platforms: $platforms, endDate: $endDate, users: $users, status: $status, gamerpowerUrl: $gamerpowerUrl)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.gamerpowerUrl, gamerpowerUrl));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(gamerpowerUrl));
  ...
  @override
  // TODO: implement open_giveaway_url
  String get open_giveaway_url => throw UnimplementedError();
}
...
abstract class _DataModel implements DataModel {
  factory _DataModel(
      ...
      required int users,
      required String status,
      required String gamerpowerUrl}) = _$_DataModel;
